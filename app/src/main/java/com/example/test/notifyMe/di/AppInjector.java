...
import com.example.test.notifyMe.NotifyMe;
...
public class AppInjector {
    ...
    public static void init(NotifyMe notifyMe) {
        DaggerAppComponent.builder().application(notifyMe)
                .build().inject(notifyMe);
